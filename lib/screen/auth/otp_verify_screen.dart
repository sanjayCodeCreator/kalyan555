...
import 'package:sm_project/controller/riverpod/auth_notifier/otp_verify_notifier.dart';
import 'package:sm_project/utils/filecollection.dart';
import 'package:stop_watch_timer/stop_watch_timer.dart';

class OTPVerifyScreen extends StatelessWidget {
  final GlobalKey<FormState> _otpVerifyKey = GlobalKey<FormState>();
  final String? userName, mobile, password;
  OTPVerifyScreen({super.key, this.userName, this.mobile, this.password});
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Consumer(builder: (context, ref, child) {
                          final refWatch = ref.watch(otpVerifyNotifierProvider);
                          final refRead =
                              ref.read(otpVerifyNotifierProvider.notifier);
