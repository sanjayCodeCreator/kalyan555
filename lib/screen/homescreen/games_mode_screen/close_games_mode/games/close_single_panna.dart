...
// import '../close_games_notifier.dart/close_single_panna_notifier.dart';

// class CloseSinglePanna extends HookConsumerWidget {
//   final String? tag;
//   final String? marketId;
//   final String? marketName;
//   const CloseSinglePanna({super.key, this.tag, this.marketId, this.marketName});
...
//               final refWatch = ref.watch(closeSinglePannaNotifierProvider);
...
//                             onTap: () {
//                               ref
//                                   .read(closeSinglePannaNotifierProvider.notifier)
//                                   .setStartDigit(i);
//                             },
//                             child: SizedBox(
//                               height: 36,
...
//                       mainAxisSpacing: 2.0,
//                       crossAxisSpacing: 2),
//                   itemCount: refWatch.value?.getSinglePannaModel().length,
//                   itemBuilder: (context, index) {
//                     final singlePanna =
//                         refWatch.value?.getSinglePannaModel()[index];

//                     return chooseNumber(
//                         context, singlePanna?.points.toString(), singlePanna);
//                   });
//             }),
//             const SizedBox(height: 20),
//             InkWell(
//               onTap: () {
//                 ref.read(closeSinglePannaNotifierProvider.notifier).addPoints();
//               },
//               child: Container(
...
//                                   ref
//                                       .read(
//                                           closeSinglePannaNotifierProvider.notifier)
//                                       .deleteAll();
//                                 },
//                                 child: Container(
//                                     padding:
...
//                             final refWatch =
//                                 ref.watch(closeSinglePannaNotifierProvider);
//                             final refRead =
//                                 ref.read(closeSinglePannaNotifierProvider.notifier);
...
//                 print('onChangedValue: $onChangedValue');
//               },
//             ))
//       ],
//     );
