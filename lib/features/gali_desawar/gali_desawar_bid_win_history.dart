...
class GaliDesawarBidWinHistoryScreen extends ConsumerStatefulWidget {
  final String tag;
  const GaliDesawarBidWinHistoryScreen({required this.tag, super.key});

  @override
  ConsumerState<GaliDesawarBidWinHistoryScreen> createState() =>
      _GaliDesawarBidWinHistoryScreenState();
}

class _GaliDesawarBidWinHistoryScreenState
    extends ConsumerState<GaliDesawarBidWinHistoryScreen>
