...
class OpenPlayGameComponent extends HookConsumerWidget {
  final GaliDeswarGameData? gameData;
  final String tag;
  const OpenPlayGameComponent({super.key, required this.tag, this.gameData});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final refRead = ref.read(openPlayNotifierProvider.notifier);
                ...
                child: Consumer(builder: (context, ref, _) {
                  ...
                  return InkWell(
                    onTap: () {
                      if (gameMode == GaliDesawarGameMode.openPlay) {
                        ref
                            .read(openPlayNotifierProvider.notifier)
                            .submitData(context, tag, gameData: gameData);
                      }
                      // if (gameMode == GaliDesawarGameMode.jantri) {
                      //   ref
              ...
              children: [
                ...
                Row(children: [
                  Expanded(child: Consumer(builder: (context, ref, _) {
                    final refWatch = ref.watch(openPlayNotifierProvider).value;
                      ...
                      suffixIcon: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Consumer(builder: (context, ref, _) {
                              // final refRead =
                              //     ref.read(openPlayNotifierProvider.notifier);
                              return InkWell(
                                onTap: () {
                                  refRead.toggleNumberWithPalti();
                                },
                                child: Column(
                                    mainAxisSize: MainAxisSize.min,
                                    children: [
                                      ...
                                      SizedBox(
                                        ...
                                        child: Consumer(
                                          ...
                                          final refWatch = ref
                                              .watch(openPlayNotifierProvider)
                                              .value;
                                          final refRead = ref.read(
                                              openPlayNotifierProvider
                                                  .notifier);
                                          return Checkbox(
                                            visualDensity:
                                            ...
                                            value: refWatch?.isNumberWithPalti,
                                            onChanged: (value) {
                                              refRead.toggleNumberWithPalti();
                                            },
                                          );
                ...
                Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                  Expanded(child: Consumer(builder: (context, ref, _) {
                    final refWatch = ref.watch(openPlayNotifierProvider).value;
                    return CustomTextFormField(
                      controller: refWatch?.harup,
                      onChanged: (value) {
                        refRead.calculateTotalAmount();
                      },
                      hintText: 'ENTER HARUP',
                      keyboardType: TextInputType.number,
                      suffixIcon: Padding(
                        padding: const EdgeInsets.fromLTRB(4, 4, 6, 4.0),
                        child: Row(
                  ...
                  Expanded(child: Consumer(builder: (context, ref, _) {
                    final refWatch = ref.watch(openPlayNotifierProvider).value;
                    return CustomTextFormField(
                      controller: refWatch?.harupAmount,
                      hintText: 'ENTER AMOUNT',
                      keyboardType: TextInputType.number,
                      onChanged: (value) {
                        ref
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(!(data?.isHarupNumber ?? false)
                                        ? data?.betNumber ?? ""
                                        : "${data?.betNumber ?? ""} ${(refWatch?.isHarupAndar ?? false) ? "A" : ""}${(refWatch?.isHarupBahar ?? false) ? "B" : ""}"),
                                    const Text("="),
                                    Text(data?.betAmount.toString() ?? ""),
                                    InkWell(
                                      onTap: () {
                                        ref
                                            .read(openPlayNotifierProvider
                                                .notifier)
