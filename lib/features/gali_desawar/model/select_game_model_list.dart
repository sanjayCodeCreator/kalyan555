class SelectGameMarketList {
  String? status;
  String? message;
  int? total;
  List<GaliDeswarGameData>? data;

  SelectGameMarketList({this.status, this.message, this.total, this.data});

  SelectGameMarketList.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    total = json['total'];
    if (json['data'] != null) {
      data = <GaliDeswarGameData>[];
      json['data'].forEach((v) {
        data!.add(GaliDeswarGameData.fromJson(v));
      });
    }
  }
...
class GaliDeswarGameData {
  ...
  GaliDeswarGameData.fromJson(Map<String, dynamic> json) {
