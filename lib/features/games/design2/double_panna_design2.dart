...
class DoublePannaDesign2 extends HookConsumerWidget {
  final String? tag;
  final String? marketId;
  final String? marketName;
  const DoublePannaDesign2(
          ...
          body: SafeArea(
            ...
            child:
              ...
              Consumer(builder: (context, ref, child) {
                final refRead = ref.read(doublePannaNotifierProvider.notifier);
                final refWatch = ref.read(doublePannaNotifierProvider).value;
                return Card(
                  color: Colors.white,
                  elevation: 3,
                          ...
                          return RawAutocomplete(
                            ...
                            optionsBuilder:
                              ...
                              if (textEditingValue.text == '') {
                                ...
                                matches.addAll(doublePannaList);
