...
import 'package:sm_project/features/games/sp_dp_tp/sp_motor_notifier.dart';
...
class SpMotor extends HookConsumerWidget {
  final String? tag;
  final String? marketId;
  final String? marketName;
  const SpMotor({this.marketName, this.tag, this.marketId, super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final getData = getSettingModel.value?.getSettingModel?.data?.rates?.main;
          ...
          bottomNavigationBar: Padding(
            ...
            child: InkWell(
              onTap: () {
                ...
                ref
                    .read(spNotifierProvider.notifier)
          ...
          body: SafeArea(
            ...
            child:
              ...
              Consumer(builder: (context, ref, child) {
                final refWatch = ref.watch(spNotifierProvider);
                final refRead = ref.read(spNotifierProvider.notifier);
                return Card(
                  color: Colors.white,
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Consumer(builder: (context, ref, child) {
                            final refWatch = ref.watch(spNotifierProvider);
                            final refRead =
                                ref.read(spNotifierProvider.notifier);
