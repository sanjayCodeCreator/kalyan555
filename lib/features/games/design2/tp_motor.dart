...
import 'package:sm_project/features/games/sp_dp_tp/tp_motor_notifier.dart';
...
class TpMotor extends HookConsumerWidget {
  final String? tag;
  final String? marketId;
  final String? marketName;
  const TpMotor({this.marketName, this.tag, this.marketId, super.key});
          ...
          bottomNavigationBar: Padding(
            ...
            child: InkWell(
              onTap: () {
                ...
                ref
                    .read(tpNotifierProvider.notifier)
          ...
          body: SafeArea(
            ...
            child:
              ...
              Consumer(builder: (context, ref, child) {
                final refWatch = ref.watch(tpNotifierProvider);
                final refRead = ref.read(tpNotifierProvider.notifier);
                return Card(
                  color: Colors.white,
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Consumer(builder: (context, ref, child) {
                            final refWatch = ref.watch(tpNotifierProvider);
                            final refRead =
                                ref.read(tpNotifierProvider.notifier);
