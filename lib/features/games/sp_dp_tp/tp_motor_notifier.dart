...
final tpNotifierProvider =
    AsyncNotifierProvider.autoDispose<TPPannaNotifier, TPMode>(() {
  return TPPannaNotifier();
});
...
class TPPannaNotifier extends AutoDisposeAsyncNotifier<TPMode> {
  final TPMode _outputMode = TPMode();
