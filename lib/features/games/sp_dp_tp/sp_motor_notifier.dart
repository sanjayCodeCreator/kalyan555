...
final spNotifierProvider =
    AsyncNotifierProvider.autoDispose<SinglePannaNotifier, SPMode>(() {
...
class SinglePannaNotifier extends AutoDisposeAsyncNotifier<SPMode> {
  final SPMode _outputMode = SPMode();
