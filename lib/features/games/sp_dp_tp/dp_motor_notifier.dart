...
final dpNotifierProvider =
    AsyncNotifierProvider.autoDispose<DPPannaNotifier, DPMode>(() {
  return DPPannaNotifier();
});
...
class DPPannaNotifier extends AutoDisposeAsyncNotifier<DPMode> {
  final DPMode _outputMode = DPMode();
