...
import 'package:sm_project/features/games/odd_even/odd_even_notifier.dart';
...
class OddEvenScreen extends HookConsumerWidget {
  final String id;
  final String tag;
  final String name;
  const OddEvenScreen({
          ...
          child: Padding(
            ...
            child: InkWell(
              onTap: () async {
                ...
                if (context.mounted) {
                  ref
                      .read(oddEvenNotifierProvider.notifier)
                  ...
                  children: [
                    ...
                    Consumer(
                      builder: (context, ref, child) {
                        final refWatch = ref.watch(oddEvenNotifierProvider);
                        final refRead = ref.read(
                          oddEvenNotifierProvider.notifier,
                        );
                        return Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: () {
                                        HapticFeedback.lightImpact();
                                        refRead.handleEvenChanged('Even');
                                      },
                                      child: Container(
                                        padding: const EdgeInsets.symmetric(
                                          horizontal: 10,
                            ...
                            child: Column(
                              children: [
                                ...
                                Consumer(
                                  builder: (context, ref, child) {
                                    final refWatch =
                                        ref.watch(oddEvenNotifierProvider);
                                    return Row(
                                      mainAxisAlignment:
