...
class SinglePanna extends HookConsumerWidget {
  final String? tag;
  final String? marketId;
  final String? marketName;
  const SinglePanna({super.key, this.tag, this.marketId, this.marketName});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    List<String> locations = ['Open', 'Close']; // Option 2
            ...
            child: InkWell(
              onTap: () {
                if (isStopGameExecution(
                    context: context, ref: ref, marketId: marketId ?? '',gameName: "Single Panna")) {
                  return;
                }
                ref
                      ...
                      children: [
                            ...
                            children: [
                              ...
                              InkWell(
                                  onTap: () {
                                    ref
                                        .read(
                                            singlePannaNotifierProvider.notifier)
                                        .deleteAll(context);
                                  },
                                  child: Container(
                                      padding:
                        ...
                        Container(
                          ...
                          child: Consumer(builder: (context, ref, child) {
                            final refWatch =
                                ref.watch(singlePannaNotifierProvider);
                            final refRead =
  ...
  Widget chooseNumber(
    ...
    return Row(
      children: [
        ...
        Consumer(builder: (context, ref, child) {
          final refGetSession = ref.watch(singlePannaNotifierProvider);
          return Container(
              height: MediaQuery.of(context).size.height * 0.07,
              decoration:  BoxDecoration(
                color: whiteBackgroundColor,
