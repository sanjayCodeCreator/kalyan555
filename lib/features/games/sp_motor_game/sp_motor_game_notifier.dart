...
final spMotorGameNotifierProvider =
    StateNotifierProvider<SpMotorGameNotifier, SpMotorGameState>((ref) {
  return SpMotorGameNotifier();
});

class SpMotorGameState {
...
class SpMotorGameNotifier extends StateNotifier<SpMotorGameState> {
  SpMotorGameNotifier() : super(SpMotorGameState()) {
  ...
  void addPoints(BuildContext context, WidgetRef ref) async {
    try {
      ...
      for (String panna in singlePannaList) {
