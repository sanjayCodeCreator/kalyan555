...
import 'package:sm_project/features/games/dp_motor_game/dp_motor_game_notifier.dart';
...
class DpMotorGameScreen extends HookConsumerWidget {
  final String id;
  final String tag;
  final String name;
  const DpMotorGameScreen(
      {super.key, required this.id, required this.tag, required this.name});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final refWatch = ref.watch(dpMotorGameNotifierProvider);
    final refRead = ref.read(dpMotorGameNotifierProvider.notifier);
                    ...
                    Container(
                      ...
                      child: Column(children: [
                        ...
                        Consumer(builder: (context, ref, child) {
                          final refWatch =
                              ref.watch(dpMotorGameNotifierProvider);
