...
class SingleDigitNew extends HookConsumerWidget {
  final String? tag;
  final String? marketId;
  final String? marketName;
  const SingleDigitNew({this.marketName, this.tag, this.marketId, super.key});
            ...
            child: Padding(
              ...
              child: InkWell(
                onTap: () {
                  ...
                  ref
                      .read(singleDigitNewNotifierProvider.notifier)
          ...
          body: SafeArea(
            ...
            child:
              ...
              Consumer(builder: (context, ref, child) {
                final refWatch = ref.watch(singleDigitNewNotifierProvider);
                return GridView.builder(
                    ...
                    itemCount: refWatch.value?.singleDigitNewModel.length ?? 0,
                    itemBuilder: (context, index) {
                      final jodi = refWatch.value?.singleDigitNewModel[index];
                      ...
                      children: [
                              ...
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    HapticFeedback.mediumImpact();
                                    ref
                                        .read(singleDigitNewNotifierProvider
                                            .notifier)
                                        .deleteAll(context);
                                  },
                                  child: Container(
                        ...
                        Container(
                          ...
                          child: Consumer(builder: (context, ref, child) {
                            final refWatch =
                                ref.watch(singleDigitNewNotifierProvider);
                            final refRead = ref
                                .read(singleDigitNewNotifierProvider.notifier);
  ...
  Widget chooseNumber(BuildContext context, String? number,
      SingleDigitNewModel? onChangedValue) {
    return Row(
      children: [
        Container(
          height: 45,
