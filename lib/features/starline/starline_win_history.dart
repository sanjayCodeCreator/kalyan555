...
class StarlineBidWinHistoryScreen extends ConsumerStatefulWidget {
  const StarlineBidWinHistoryScreen({super.key});

  @override
  ConsumerState<StarlineBidWinHistoryScreen> createState() =>
      _StarlineBidWinHistoryScreenState();
}

class _StarlineBidWinHistoryScreenState
    extends ConsumerState<StarlineBidWinHistoryScreen>
  ...
  void initState() {
    ...
    ref
      ...
      final userId = ref
          ...
          '';
      _currentQuery =
          userId.isEmpty ? '' : '?user_id=$userId&tag=starline&win=true';
      ref
